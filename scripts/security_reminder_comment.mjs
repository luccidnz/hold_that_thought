...
const comment = `**Security:** Token(s) previously used must be revoked/rotated in GitHub → Settings → Developer settings. CI now blocks \`.env\` and scans for secrets.`;
...
console.log(`Security reminder comment posted to PR #${prNumber}`);
